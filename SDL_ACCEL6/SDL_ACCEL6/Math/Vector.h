...
void reflect2(float * restrict a, float * restrict b, //inputs
             float * restrict c //result vector
) {
    float f1 = dot(b, a);
    vec temp;
...
void refract2(float * restrict a, float * restrict b, float n, float NdotI, float cos_t, //inputs
             float * restrict c //result vector
) {
